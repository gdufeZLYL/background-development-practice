...
# 示例
# response = requests.get("https://alpha.wallhaven.cc/")
...
# 示例
# r = requests.get("https://alpha.wallhaven.cc/")
# print(r.text)
# print(r.content)
# # print(r.json()) # 报错
# print(r.encoding)
...
# r.encoding = "ISO-8859-1"
# print(r.text)
# r = requests.get("http://www.gdufe.edu.cn/")
# r.encoding = "ISO-8859-1"
# print(r.text)
# r = requests.get("http://www.gdufe.edu.cn/")
# r.encoding = "utf-8"
...
# 示例
# r = requests.get("http://www.gdufe.edu.cn/", stream=True)
# print(r.raw)
# print(r.raw.read(10))
...
# 示例
# files = {"file": ("report.xls", open("test", "rb"), "application/vnd.ms-excel", {"Expires": "0"})}
# r = requests.post("http://httpbin.org/post", files=files)
# print(r.text)
...
# # s.get("http://httpbin.org/cookies/set/sessioncookie/12345678910")
...
# response = s.get("http://httpbin.org/cookies/set/sessioncookie/12345678910")
# print(requests.utils.dict_from_cookiejar(response.cookies))
...
# for cookie in s.cookies:
#     print(cookie)
# requests.utils.add_dict_to_cookiejar(s.cookies, {"cookie_key2": "cookie_value2"})
# for cookie in s.cookies:
#     print(cookie)
...
# s.auth = ("user", "pass")
# s.headers.update({"x-test": "true"})
# response = s.get("http://httpbin.org/headers", headers={"x-test2": "true"})
...
# print(response.text)    # {"cookies":{"from-my":"browser","sessioncookie":"123456789"}}
