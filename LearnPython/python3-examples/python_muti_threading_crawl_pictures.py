...
if __name__ == '__main__':
    ...
    #搜索关键字并下载百度图片
    word = u'皮卡丘'
    # downloadImgFromBaiduimage('baiduimage_'+word+'_' + now,  word)
    # 下载百度帖子内所有图片
    # downloadImgFromBaidutieba('tieba_'+now, 'https://tieba.baidu.com/p/5256331871')
    #  爬虫搜索并下载美女图片地址：http://huaban.com
    downloadImgFromhuaban('huaban_'+now)